...
$router->addGroup("/{$module}", function (FastRoute\RouteCollector $router) {
  ...
  /**
   * @OA\Post(
   *     path="/api/webstack/content/insert",
   *     @OA\RequestBody(
   *         required=true,
  ...
  /**
   * @OA\Post(
   *     path="/api/webstack/content/delete",
   *     @OA\RequestBody(
   *         required=true,
   *         @OA\JsonContent(ref="#/components/schemas/ContentModel")
   *     ),
  ...
  /**
   * @OA\Post(
   *     path="/api/webstack/content/update",
   *     @OA\RequestBody(
   *         required=true,
   *         @OA\JsonContent(ref="#/components/schemas/ContentModel")
   *     ),
  ...
  /**
   * @OA\Post(
   *     path="/api/webstack/content/count",
   *     @OA\RequestBody(
   *         required=true,
   *         @OA\JsonContent(ref="#/components/schemas/ContentModel")
   *     ),
  ...
  /**
   * @OA\Post(
   *     path="/api/webstack/content/list",
   *     @OA\RequestBody(
   *         required=true,
   *         @OA\JsonContent(ref="#/components/schemas/ContentModel")
   *     ),
  ...
  /**
   * @OA\Post(
   *     path="/api/webstack/content/tree",
   *     @OA\RequestBody(
   *         required=true,
   *         @OA\JsonContent(ref="#/components/schemas/ContentModel")
   *     ),
  ...
  /**
   * @OA\Post(
   *     path="/api/webstack/content/info",
   *     @OA\RequestBody(
   *         required=true,
   *         @OA\JsonContent(ref="#/components/schemas/ContentModel")
   *     ),
