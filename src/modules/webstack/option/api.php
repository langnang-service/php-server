...
$router->addGroup("/{$module}", function (FastRoute\RouteCollector $router) {
  ...
  /**
   * @OA\Post(
   *     path="/api/webstack/option/insert",
   *     @OA\RequestBody(
   *         required=true,
  ...
  /**
   * @OA\Post(
   *     path="/api/webstack/option/delete",
   *     @OA\RequestBody(
   *         required=true,
   *         @OA\JsonContent(ref="#/components/schemas/OptionModel")
   *     ),
  ...
  /**
   * @OA\Post(
   *     path="/api/webstack/option/update",
   *     @OA\RequestBody(
   *         required=true,
   *         @OA\JsonContent(ref="#/components/schemas/OptionModel")
   *     ),
